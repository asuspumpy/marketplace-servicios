...
exports.mpWebhookHandler = exports.createPreference = void 0;
// @ts-ignore
const mercadopago_1 = require("mercadopago");
// Configuración Global SDK - Obtenemos el Token del Environment (MOCK para el Sandbox)
const client = new mercadopago_1.MercadoPagoConfig({ accessToken: process.env.MP_ACCESS_TOKEN || 'TEST-00000000000-000000-00000' });
...
const mpWebhookHandler = async (req, res) => {
    try {
